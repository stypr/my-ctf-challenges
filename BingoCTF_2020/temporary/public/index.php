...
<head>
  ...
  <title>HypwnLab Temporary Website</title>
...
<body>
  ...
  <header id="header" class="fixed-top header-transparent">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="index.html">HypwnLab</a></h1>
    ...
    <div class="container d-flex h-100">
      <div class="row justify-content-center align-self-center" data-aos="fade-up">
        <div class="col-md-6 intro-info order-md-first order-last" data-aos="zoom-in" data-aos-delay="100">
          <h2>Sleep, Pwn, Pwn, Eat, Pwn, Pwn, Eat, Pwn, Game, Pwn, Repeat</h2>
          <div>
        ...
        <div class="row">
          ...
          <div class="col-lg-5 col-md-6">
            <div class="about-img" data-aos="fade-right" data-aos-delay="100">
              <img src="image.php?url=https://raw.githubusercontent.com/HypwnLab/hypwnlab.github.io/master/images/logo1.jpg" alt="">
            </div>
          </div>
